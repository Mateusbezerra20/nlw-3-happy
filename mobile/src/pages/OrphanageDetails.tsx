...
import { useRoute } from '@react-navigation/native' //Usaremos para pegar o params id
...
export default function OrphanageDetails() {
  ...
  if(!orphanage){
    // Ainda não sei porque quando a ausência desse tratamento provoca um erro
    return (
  ...
  function handleOpenGoogleMapsRoutes() {
    // Linking serve para abrir links no navegador
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.imagesContainer}>
        <ScrollView horizontal pagingEnabled>
          {/* Scrollview permite rolar a tela horizontalmente */}
